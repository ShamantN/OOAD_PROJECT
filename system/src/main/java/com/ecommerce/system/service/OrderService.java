...
public class OrderService {
    ...
    public CancellationImpact cancelOrder(int orderId) {
        ...
        // Calculate the financial impact based on current state
        ...
        if (order.getStatus() == OrderStatus.SHIPPED) {
            ...
            // CREATED or PAID: Full refund, no penalties
            impact.setCancellationFee(0.0);
            impact.setDeliveryChargeLoss(0.0);
        }
        
        // Runs: finalRefund = totalAmount - cancellationFee - deliveryChargeLoss
